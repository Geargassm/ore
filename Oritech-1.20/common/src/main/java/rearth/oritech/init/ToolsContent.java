...
public class ToolsContent implements ArchitecturyRegistryContainer<Item> {
    ...
    public static final Item ELECTRIC_MACE = new ElectricMaceItem(UNBREAKING_SETTINGS.rarity(Rarity.EPIC));

    public static final Item CHAINSAW = new ChainsawItem(ELECTRIC_MATERIAL, ELECTRIC_SETTINGS);
    public static final Item HAND_DRILL = new DrillItem(ELECTRIC_MATERIAL, TagContent.DRILL_MINEABLE, ELECTRIC_SETTINGS);

    public static final Item PROMETHIUM_AXE = new PromethiumAxeItem(PROMETHIUM_MATERIAL, UNBREAKING_SETTINGS.rarity(Rarity.EPIC));
    public static final Item PROMETHIUM_PICKAXE = new PromethiumPickaxeItem(PROMETHIUM_MATERIAL, TagContent.DRILL_MINEABLE, UNBREAKING_SETTINGS.rarity(Rarity.EPIC));
