...
public class ParticleContent {
    ...
    public record Payload(int effectId, Vec3 pos, Vec3 data1, Vec3 data2, int extraInt) {
        ...
        public static final StreamCodec<FriendlyByteBuf, Payload> PACKET_CODEC = new StreamCodec<>() {
            @Override
            public Payload decode(FriendlyByteBuf buf) {
                return new Payload(
                    buf.readInt(),
            ...
            @Override
            public void encode(FriendlyByteBuf buf, Payload value) {
