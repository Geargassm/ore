...
public class SmallEnergyStorageBlockItem extends BlockItem implements EnergyApi.ItemProvider {
    ...
    public boolean isBarVisible(ItemStack stack) {
        var contentEmpty = (stack.hasTag() ? stack.getOrCreateTag().getLong("oritech_energy") : 0L) <= 0;
        return !contentEmpty;
    }
    ...
    public int getBarWidth(ItemStack stack) {
        ...
        var fillAmount = stack.hasTag() ? stack.getOrCreateTag().getLong("oritech_energy") : 0L;
